...
\hypersetup{unicode=true,
            pdftitle={Liver Disease Classification Project},
...
\CommentTok{# Indian Live Patient Records :}
 ...
 \CommentTok{# https://archive.ics.uci.edu/ml/machine-learning-databases/00225/Indian 
Liver Patient Dataset (ILPD).csv}

\NormalTok{url <-}\StringTok{ "https://archive.ics.uci.edu/ml/machine-learning-databases/00225/Indian 
Liver Patient Dataset (ILPD).csv"}
...
\KeywordTok{colnames}\NormalTok{(liverData)<-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Age"}\NormalTok{,}\StringTok{"Gender"}\NormalTok{,}\StringTok{"Total_Bilirubin"}\NormalTok{,}\StringTok{"Direct_Bilirubin"}
\NormalTok{, }\StringTok{"Alkaline_Phosphotase"}\NormalTok{,}\StringTok{"Alamine_Aminotransferase"}\NormalTok{,}\StringTok{"Aspartate_Aminotransferase"}
\NormalTok{,}\StringTok{"Total_Protiens"}\NormalTok{,}\StringTok{"Albumin"}\NormalTok{,}\StringTok{"Albumin_and_Globulin_Ratio"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{sprintf}\NormalTok{(}\StringTok{"Patient records in validation dataset = %d"}\NormalTok{, }\KeywordTok{nrow}\NormalTok{(validation))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{training}\OperatorTok{$}\NormalTok{Albumin_and_Globulin_Ratio[}\KeywordTok{is.na}\NormalTok{(training}\OperatorTok{$}\NormalTok{Albumin_and_Globulin_Ratio)] <-}
\StringTok{ }\KeywordTok{mean}\NormalTok{(training}\OperatorTok{$}\NormalTok{Albumin_and_Globulin_Ratio, }\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{center}
\includegraphics[width=0.7\textwidth]{LiverDisease_files/figure-latex/unnamed-chunk-11-1.pdf}
\end{center}

Now, we breakdown the distribution of ages to the presence or absence of
liver diseases. Again, we notice a good spread of age group for both
scenarios.
...
\begin{center}
\includegraphics[width=0.6\textwidth]{LiverDisease_files/figure-latex/unnamed-chunk-15-1.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.65\textwidth]{LiverDisease_files/figure-latex/unnamed-chunk-19-1.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.65\textwidth]{LiverDisease_files/figure-latex/unnamed-chunk-22-1.pdf}
\end{center}
...
\begin{verbatim}
## [1] "The accuracy of GLM = 0.705423"
\end{verbatim}
...
We use \emph{knn} method to train the model. We tune the model with
several values of \emph{k}, ranging from 3 to 51, to optimize the
performance.
...
\NormalTok{tune_grid <-}\StringTok{ }\KeywordTok{expand.grid}\NormalTok{(}\DataTypeTok{k =} \KeywordTok{seq}\NormalTok{(}\DecValTok{3}\NormalTok{, }\DecValTok{51}\NormalTok{, }\DecValTok{2}\NormalTok{))}
...
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"The best accuracy = "}\NormalTok{,}\KeywordTok{round}\NormalTok{(}\KeywordTok{max}\NormalTok{(train_knn}\OperatorTok{$}\NormalTok{results}\OperatorTok{$}\NormalTok{Accuracy),}\DecValTok{3}\NormalTok{), }\StringTok{" K ="}\NormalTok{,train_knn}\OperatorTok{$}\NormalTok{bestTune}\OperatorTok{$}\NormalTok{k))}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"The best accuracy = "}\NormalTok{,}\KeywordTok{round}\NormalTok{(}\KeywordTok{max}\NormalTok{(train_loess}\OperatorTok{$}\NormalTok{results}\OperatorTok{$}\NormalTok{Accuracy),}\DecValTok{3}\NormalTok{),}
                \StringTok{"Span = "}\NormalTok{, }\KeywordTok{round}\NormalTok{(train_loess}\OperatorTok{$}\NormalTok{bestTune}\OperatorTok{$}\NormalTok{span,}\DecValTok{3}\NormalTok{),}
                \StringTok{"Degree = "}\NormalTok{, }\KeywordTok{round}\NormalTok{(train_loess}\OperatorTok{$}\NormalTok{bestTune}\OperatorTok{$}\NormalTok{degree,}\DecValTok{1}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"The best accuracy = "}\NormalTok{,}\KeywordTok{round}\NormalTok{(}\KeywordTok{max}\NormalTok{(train_pls}\OperatorTok{$}\NormalTok{results}\OperatorTok{$}\NormalTok{Accuracy),}\DecValTok{3}\NormalTok{),}
                \StringTok{"Ncomp= "}\NormalTok{,train_pls}\OperatorTok{$}\NormalTok{bestTune}\OperatorTok{$}\NormalTok{ncomp))}
\end{Highlighting}
\end{Shaded}

\begin{center}
\includegraphics[width=0.65\textwidth]{LiverDisease_files/figure-latex/unnamed-chunk-28-1.pdf}
\end{center}
...
The \emph{lda} is a statistical classifier, and we use this method for
training. There is no parameter to tune for this model.
...
\begin{verbatim}
## [1] "The accuracy of lda = 0.713171"
\end{verbatim}
...
The \emph{qda} is a statistical classifier, and we use the method for
training. There is no parameter to tune for this model.
...
\begin{verbatim}
## [1] "The accuracy of qda = 0.556785"
\end{verbatim}
...
We use \emph{raprt} method with cross-validation for training. We tune
the \emph{cp} parameter to optimize the performance of the model.
...
\CommentTok{# Define tuning parameters}
\NormalTok{tune_grid <-}\StringTok{ }\KeywordTok{expand.grid}\NormalTok{(}\DataTypeTok{cp =} \KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{0.08}\NormalTok{, }\DataTypeTok{len =} \DecValTok{10}\NormalTok{))}
...
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"The best accuracy = "}\NormalTok{,}\KeywordTok{round}\NormalTok{(}\KeywordTok{max}\NormalTok{(train_rpart}\OperatorTok{$}\NormalTok{results}\OperatorTok{$}\NormalTok{Accuracy),}\DecValTok{3}\NormalTok{),}
                \StringTok{"CP = "}\NormalTok{, }\KeywordTok{round}\NormalTok{(train_rpart}\OperatorTok{$}\NormalTok{bestTune}\OperatorTok{$}\NormalTok{cp,}\DecValTok{2}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"The best accuracy = "}\NormalTok{,}\KeywordTok{round}\NormalTok{(}\KeywordTok{max}\NormalTok{(train_rf}\OperatorTok{$}\NormalTok{results}\OperatorTok{$}\NormalTok{Accuracy),}\DecValTok{3}\NormalTok{),}
                \StringTok{"Mtry = "}\NormalTok{, }\KeywordTok{round}\NormalTok{(train_rf}\OperatorTok{$}\NormalTok{bestTune}\OperatorTok{$}\NormalTok{mtry,}\DecValTok{1}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}

\begin{center}
\includegraphics[width=0.65\textwidth]{LiverDisease_files/figure-latex/unnamed-chunk-32-1.pdf}
\end{center}
...
We use support vector machine for training. We tune the \emph{tau}
parameter to optimize the performance of the model.
...
\CommentTok{# Define tuning parameters}
\NormalTok{tune_grid <-}\StringTok{ }\KeywordTok{expand.grid}\NormalTok{(}\DataTypeTok{tau=}\KeywordTok{seq}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{8}\NormalTok{))}
...
\NormalTok{train_svm <-}\StringTok{ }\KeywordTok{train}\NormalTok{(LiverDisease}\OperatorTok{~}\NormalTok{.,}
                   ...
                   \DataTypeTok{tune_grid=}\NormalTok{ tune_grid,}
                   \DataTypeTok{trControl =}\NormalTok{ control)}

\CommentTok{# Plot the model and highlight the best result}
\KeywordTok{ggplot}\NormalTok{(train_rf, }\DataTypeTok{highlight =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"The best accuracy = "}\NormalTok{,}\KeywordTok{round}\NormalTok{(}\KeywordTok{max}\NormalTok{(train_svm}\OperatorTok{$}\NormalTok{results}\OperatorTok{$}\NormalTok{Accuracy),}\DecValTok{3}\NormalTok{),}
                \StringTok{"Tua = "}\NormalTok{, }\KeywordTok{round}\NormalTok{(train_svm}\OperatorTok{$}\NormalTok{bestTune}\OperatorTok{$}\NormalTok{C,}\DecValTok{1}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}

\begin{center}
\includegraphics[width=0.65\textwidth]{LiverDisease_files/figure-latex/unnamed-chunk-33-1.pdf}
\end{center}
...
\NormalTok{  greenPalette <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"#F7FCF5"}\NormalTok{,}\StringTok{"#E5F5E0"}\NormalTok{,}\StringTok{"#C7E9C0"}\NormalTok{,}\StringTok{"#A1D99B"}\NormalTok{,}\StringTok{"#74C476"}\NormalTok{,}\StringTok{"#41AB5D"}\NormalTok{,}\StringTok{"#238B45"}
\NormalTok{,}\StringTok{"#006D2C"}\NormalTok{,}\StringTok{"#00441B"}\NormalTok{)}
\NormalTok{  redPalette <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"#FFF5F0"}\NormalTok{,}\StringTok{"#FEE0D2"}\NormalTok{,} \StringTok{"#FCBBA1"}\NormalTok{,}\StringTok{"#FC9272"}\NormalTok{,}\StringTok{"#FB6A4A"}\NormalTok{,}\StringTok{"#EF3B2C"}\NormalTok{,}\StringTok{"#CB181D"}
\NormalTok{,}\StringTok{"#A50F15"}\NormalTok{,}\StringTok{"#67000D"}\NormalTok{)}
...
\begin{center}
\includegraphics[width=0.65\textwidth]{LiverDisease_files/figure-latex/unnamed-chunk-49-1.pdf}
\end{center}
...
problem of imbalanced data via weight balancing \cite{wb}. The weight balancing
...
\bibitem{wb}
George Seif, "Handling Imbalanced Datasets in Deep Learning", \url={"https://towardsdatascience.com/handling-imbalanced-datasets-in-deep-learning-f48407a0e758"}
\end{thebibliography}
