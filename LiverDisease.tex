...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{sprintf}\NormalTok{(}\StringTok{"Rows of validation dataset = %d"}\NormalTok{, }\KeywordTok{nrow}\NormalTok{(validation))}
\end{Highlighting}
\end{Shaded}
...
method to train the model. We use the same tuning, which was used before
