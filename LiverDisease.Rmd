...
We use \emph{loess} methof with cross-validation of 10 folds to train the model. We also optimize span parameter of the method.
...
tune_grid <- expand.grid(span = seq(0.15, 0.65, len = 10), degree = 1)
