...
```{r}
library(caret)
train_glm <- train(Disease~Total_Bilirubin+Direct_Bilirubin+Alkaline_Phosphotase+Alamine_Aminotransferase+Aspartate_Aminotransferase, method = "glm", data = training)
...
```{r}
library(caret)
train_knn <- train(Disease~Total_Bilirubin+Direct_Bilirubin+Alkaline_Phosphotase+Alamine_Aminotransferase+Aspartate_Aminotransferase, method = "knn", 
                   data = training,
                   tuneGrid = data.frame(k = seq(3, 25, 2)))
...
train_pls <- train(Disease~Total_Bilirubin+Direct_Bilirubin+Alkaline_Phosphotase+Alamine_Aminotransferase+Aspartate_Aminotransferase, 
                     method = "pls",
                     data = training,
                     preProc = c("center", "scale"),
                      tuneLength = 15,
                      trControl = ctrl)
print(train_pls$results$Accuracy)
...
train_lda <- train(Disease~Total_Bilirubin+Direct_Bilirubin+Alkaline_Phosphotase+Alamine_Aminotransferase+Aspartate_Aminotransferase, 
                     method = "lda",
                     data = training,
                      trControl = ctrl)
print(train_lda$results$Accuracy)
...
train_qda <- train(Disease~Total_Bilirubin+Direct_Bilirubin+Alkaline_Phosphotase+Alamine_Aminotransferase+Aspartate_Aminotransferase, 
                     method = "qda",
                     data = training,
                      trControl = ctrl)
print(train_qda$results$Accuracy)
...
train_rpart <- train(Disease~Total_Bilirubin+Direct_Bilirubin+Alkaline_Phosphotase+Alamine_Aminotransferase+Aspartate_Aminotransferase, 
                     method = "rpart",
                     data = training,
                      trControl = ctrl,
...
train_rpart <- train(Disease~Total_Bilirubin+Direct_Bilirubin+Alkaline_Phosphotase+Alamine_Aminotransferase+Aspartate_Aminotransferase, 
                     ...
                     ntree=100)
#qplot(nodesize, acc)
print(train_rpart$results$Accuracy)
```
